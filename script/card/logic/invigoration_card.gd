class_name InvigorationCard
extends Card

var stacks : int = 1
var status_id : String = "invigoration_status"
static var ARMOR_AMOUNT : int = 40
static var EMPOWERED_AMOUNT : int = 1
...
func build_sequence(context: BattleContext, controller: BattleController, preview: bool = false) -> EffectSequenceBuilder:
	...
	var effect = InvigorationStatusEffect.new(status_id, 
		stacks)
